package com.example.parkpromain.adapter
...
class BestLessonAdapter(
    private val context: Context,
    private val dataset: ArrayList<CoachingsSalesBestResult>?
) : RecyclerView.Adapter<BestLessonAdapter.BestLessonViewHolder>() {
